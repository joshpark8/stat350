...
\newcommand{\ze}{\tun{0}}   % Zero element of vector space
\renewcommand{\u}{\tun{u}}  % u element of vector space
\renewcommand{\v}{\tun{v}}  % u element of vector space
\newcommand{\w}{\tun{w}}    % w element of vector space
\newcommand{\x}{\tun{x}}    % x element of vector space
\newcommand{\y}{\tun{y}}    % y element of vector space
\newcommand{\z}{\tun{z}}    % z element of vector space

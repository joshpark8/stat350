...
\newcommand{\ze}{\uline{0}}   % Zero element of vector space
\renewcommand{\u}{\uline{u}}  % u element of vector space
\renewcommand{\v}{\uline{v}}  % u element of vector space
\newcommand{\w}{\uline{w}}    % w element of vector space
\newcommand{\x}{\uline{x}}    % x element of vector space
\newcommand{\y}{\uline{y}}    % y element of vector space
\newcommand{\z}{\uline{z}}    % z element of vector space

...
\dfn{Parameter}{a \ital{\ul parameter} is a number that represents a characteristics of a \ul population}
\ex{Parameter}{$\mu, \sigma$}


\dfn{Statistic}{a \ital{\ul statistic} is any number calculated from a \ul sample}
\ex{Statistic}{$\xbar, s$}
...
\dfn{Sampling distribution}{the probability distribution of a statistic is called a \ital{sampling distribution}}

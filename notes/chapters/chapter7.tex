...
\dfn{Parameter}{a \tit{\tun parameter} is a number that represents a characteristics of a \tun population}
\ex{Parameter}{$\mu, \sigma$}


\dfn{Statistic}{a \tit{\tun statistic} is any number calculated from a \tun sample}
\ex{Statistic}{$\xbar, s$}

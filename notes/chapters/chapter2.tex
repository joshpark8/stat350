...
\dfn{Bins}{intervals that categorical variables are sorted into}
\dfn{Frequency distribution}{the frequency of number of observations in each class}
\dfn{relative frequency}{the measured frequency divided by the total data points}
\begin{equation}

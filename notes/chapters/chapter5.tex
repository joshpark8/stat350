...
\dfn{Binomial Random Variable}{The \tit{binomial random variable} $X$ must come from a binomial experiment and maps every outcome to some $k\in\R$. $X$ has parameters $n$ (num trials) and $p$ (prob success).}
